  ...
  return (
    <div className={`${containerStyles}`}>
       ...
       >
        ...
        {/* nav close btn */}
        <div onClick={()=> setIsOpen(false)} className='cursor-pointer text-4xl text-white absolute w-10 h-10 left-8
       ...
       <div className="py-4">
            <p className="text-white/60 text-center text-sm"> Desarrollado por <span className="text-orange font-semibold">Oscar Garcia</span> &copy;</p>
        </div>
       </aside>
    </div>
  )
